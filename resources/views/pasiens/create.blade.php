...
<div class="max-w-4xl mx-auto pb-10">
    <div class="mb-6">
        <a href="{{ route('pasiens.index') }}" class="inline-flex items-center text-sm font-medium text-slate-500 hover:text-red-600 transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-sm ring-1 ring-slate-200 overflow-hidden">
        ...
        <form action="{{ route('pasiens.store') }}" method="POST" class="px-6 py-8 sm:p-10">
            ...
            <div class="space-y-12">
                ...
                <div>
                    <h3 class="text-base font-semibold leading-7 text-slate-900 flex items-center gap-2 mb-6">
                        <span class="bg-red-100 text-red-700 h-6 w-6 rounded-full flex items-center justify-center text-sm">1</span>
                        Informasi Utama
                    </h3>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-2 relative">
                                ...
                                <input type="text" name="no_reg" id="no_reg" required value="{{ old('no_reg', date('YmdHis')) }}" class="block w-full rounded-xl border-0 py-2.5 pl-10 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6" readonly>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" class="block w-full rounded-xl border-0 py-2.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 transition-shadow">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <h3 class="text-base font-semibold leading-7 text-slate-900 flex items-center gap-2 mb-6">
                        <span class="bg-red-100 text-red-700 h-6 w-6 rounded-full flex items-center justify-center text-sm">2</span>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-2 relative">
                                <select id="status" name="status" class="block w-full appearance-none rounded-xl border-0 py-2.5 pl-4 pr-10 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 bg-white transition-shadow">
                        ...
                        <div>
                            ...
                            <div class="mt-2 relative">
                                <select id="cara_bayar" name="cara_bayar" class="block w-full appearance-none rounded-xl border-0 py-2.5 pl-4 pr-10 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6 bg-white transition-shadow">
            ...
            <div class="mt-10 flex items-center justify-end gap-x-4 border-t border-slate-100 pt-8">
                ...
                <button type="submit" class="rounded-xl bg-red-600 px-8 py-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 transition-all">
                    Simpan Data Pasien
                </button>
            </div>
        </form>
