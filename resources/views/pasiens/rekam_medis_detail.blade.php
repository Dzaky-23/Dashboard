    ...
    <div class="flex flex-col md:flex-row md:items-start lg:items-center justify-between mt-4 gap-4">
        <div>
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3 mt-2">
                ...
                @if($rm->status)
                    <span class="inline-flex items-center rounded-full bg-orange-50 px-2.5 py-1 text-xs font-medium text-orange-700 ring-1 ring-inset ring-orange-700/10 whitespace-nowrap">{{ $rm->status }}</span>
                @endif
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <button type="button" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 transition-colors">
