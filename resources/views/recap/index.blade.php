                    ...
                    @else
                        ...
                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-slate-200 pb-4 mb-6 gap-4">
                            ...
                            <div class="relative w-full md:w-72">
                                ...
                                <input x-model="search" type="text" placeholder="Cari wilayah/instansi..." class="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-lg leading-5 bg-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm transition duration-150 ease-in-out shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-2 mb-8 bg-slate-100/80 p-1.5 rounded-xl border border-slate-200 sm:inline-flex w-full sm:w-auto shadow-inner">
                            ...
                            <button @click="activeFilter = 'kecamatan'" :class="{'bg-white text-indigo-700 shadow-sm ring-1 ring-slate-200/60 font-bold': activeFilter === 'kecamatan', 'text-slate-500 hover:bg-slate-200/50 hover:text-slate-700 font-medium': activeFilter !== 'kecamatan'}" class="flex-1 sm:flex-none px-5 py-2.5 rounded-lg text-sm transition-all duration-200 ease-in-out flex items-center justify-center gap-2">
                                <span x-show="activeFilter === 'kecamatan'" class="w-1.5 h-1.5 rounded-full bg-indigo-600"></span>
                                Hanya Kecamatan
                            </button>
